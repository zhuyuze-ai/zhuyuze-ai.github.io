...
\begin{minipage}[t]{0.73\textwidth} 
    ...
    {\large
    \faUniversity\ 加州大学伯克利分校 (UC Berkeley)，访问学生 \\[0.4em]
    \faUniversity\ 中国科学院大学，北京，101408 \\[0.4em]
...
% ----------------------------------------------------------------------------------------
\section{教育背景}
\textbf{加州大学伯克利分校 (UC Berkeley)} \hfill 美国加州伯克利 \\
\textit{访问学生，计算机科学} \hfill 2026.08 -- 至今

\vspace{0.4em}
\textbf{中国科学院大学 (UCAS)} \hfill 中国北京 \\
\textit{人工智能专业工学学士，人工智能学院（大四在读）} \hfill 2023.09 -- 2027.07 (预计)
\begin{itemize}
...
% ----------------------------------------------------------------------------------------
\section{实习经历}
\textbf{中科第五纪 (FiveAges)} \hfill 具身智能算法实习生 \\
\textit{具身智能算法组，北京} \hfill 2026.03 -- 2026.08 \\
\textit{(导师：黄岩 研究员)}
\begin{itemize}
    \item \textbf{研究方向:} 具身智能算法研发，聚焦\textbf{视觉-语言-动作 (VLA)} 模型。
    \item \textbf{核心工作:} 参与 VLA 模型的算法研究与工程落地，致力于在真实机器人系统上部署并验证算法，推动学术研究与产业应用的衔接。
    \item \textbf{成果产出:} 以共同第一作者身份完成 \textbf{BridgeVLA++}——一个数据高效、可泛化、带记忆增强的面向三维操作的 VLA 框架（arXiv:2608.05042）。
\end{itemize}
...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{成果产出:} 作为第二作者合作撰写论文一篇，\textbf{已被 ICML 2026 录用}。
\end{itemize}
...
\section{论文发表}
\begin{itemize}
    \item Peiyan Li$^*$, \textbf{Yuze Zhu}$^*$, Yixiang Chen, Qisen Ma, Yuan Xu, Jiabing Yang, He Guan, Yan Huang, Hongtao Wu, Xiao Ma, Tao Kong, Liang Wang, Tieniu Tan. ``\textit{BridgeVLA++: A Data-Efficient, Generalizable, and Memory-Augmented Vision-Language-Action Framework for 3D Manipulation}''. \textit{arXiv preprint arXiv:2608.05042}, 2026. ($^*$共同第一作者) \hfill \textbf{预印本}
    \item Xuan Yao, \textbf{Yuze Zhu}, Junyu Gao, Zongmeng Wang, Changsheng Xu. ``\textit{SC$^2$-WM: A Self-Correcting World Model with Closed-Loop Feedback for Vision-and-Language Navigation in Continuous Environments}''. \textit{International Conference on Machine Learning (ICML)}, 2026. \hfill \textbf{已录用}
\end{itemize}
...
\section{荣誉奖项}
\begin{itemize}
    \item \textbf{优秀共青团员}，中国科学院大学 \hfill 2025 -- 2026
    \item \textbf{三好学生}，中国科学院大学 \hfill 2023、2024、2025
