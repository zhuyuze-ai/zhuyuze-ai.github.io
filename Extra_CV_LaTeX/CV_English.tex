...
\begin{minipage}[t]{0.73\textwidth} 
    ...
    {\large
    \faUniversity\ Visiting Student, University of California, Berkeley \\[0.4em]
...
\textit{Visiting Student, Computer Science} \hfill Aug. 2026 -- Present

\vspace{0.4em}
\textbf{University of Chinese Academy of Sciences (UCAS)} \hfill Beijing, China \\
\textit{B.Eng. in Artificial Intelligence, School of Artificial Intelligence (Senior)} \hfill Sep. 2023 -- Jul. 2027 (Expected)
\begin{itemize}
...
\textit{Embodied AI Algorithm Team, Beijing} \hfill Mar. 2026 -- Aug. 2026 \\
...
\begin{itemize}
    ...
    \item \textbf{Core Work:} Contributed to the research and engineering of VLA models, and their deployment and verification on real-world robotic systems, bridging academic research with industrial applications.
    \item \textbf{Outcome:} Co-first-authored \textbf{BridgeVLA++}, a data-efficient, generalizable, and memory-augmented VLA framework for 3D manipulation (arXiv:2608.05042).
\end{itemize}
...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Outcome:} Co-authored a paper as the second author, \textbf{accepted by ICML 2026}.
\end{itemize}
...
\begin{itemize}
    \item Peiyan Li$^*$, \textbf{Yuze Zhu}$^*$, Yixiang Chen, Qisen Ma, Yuan Xu, Jiabing Yang, He Guan, Yan Huang, Hongtao Wu, Xiao Ma, Tao Kong, Liang Wang, Tieniu Tan. ``\textit{BridgeVLA++: A Data-Efficient, Generalizable, and Memory-Augmented Vision-Language-Action Framework for 3D Manipulation}''. \textit{arXiv preprint arXiv:2608.05042}, 2026. ($^*$Equal contribution) \hfill \textbf{Preprint}
    \item Xuan Yao, \textbf{Yuze Zhu}, Junyu Gao, Zongmeng Wang, Changsheng Xu. ``\textit{SC$^2$-WM: A Self-Correcting World Model with Closed-Loop Feedback for Vision-and-Language Navigation in Continuous Environments}''. \textit{International Conference on Machine Learning (ICML)}, 2026. \hfill \textbf{Accepted}
\end{itemize}
...
\begin{itemize}
    \item \textbf{Outstanding Youth League Member}, University of Chinese Academy of Sciences \hfill 2025 -- 2026
    \item \textbf{Merit Student}, University of Chinese Academy of Sciences \hfill 2023, 2024, 2025
