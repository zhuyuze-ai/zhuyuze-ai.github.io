...
% ----------------------------------------------------------------------------------------
% Font Settings (Standard English Fonts)
% ----------------------------------------------------------------------------------------
...
\begin{minipage}[t]{0.73\textwidth} 
    ...
    {\large
    \faUniversity\ University of Chinese Academy of Sciences, Beijing, PRC, 100049 \\[0.4em]
...
% ----------------------------------------------------------------------------------------
\section{Experience}
\textbf{FiveAges (中科第五纪)} \hfill Embodied AI Algorithm Research Intern \\
